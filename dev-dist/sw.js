...
define(['./workbox-8414606a'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/(fonts\.googleapis\.com|fonts\.gstatic\.com|ui-avatars\.com|images\.unsplash\.com)/, new workbox.StaleWhileRevalidate({
